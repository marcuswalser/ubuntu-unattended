...
if [[ ! -f $tmp/$seed_file ]]; then
    ...
    download "https://raw.githubusercontent.com/marcuswalser/ubuntu-unattended/master/$seed_file"
fi
...
if [ $ub1604 == "yes" ]; then
   late_command="apt-install wget; in-target wget --no-check-certificate -O /home/$username/start.sh https://github.com/marcuswalserubuntu-unattended/raw/master/start.sh ;\
     in-target chmod +x /home/$username/start.sh ;"
else
   late_command="chroot /target wget -O /home/$username/start.sh https://github.com/marcuswalserubuntu-unattended/raw/master/start.sh ;\
